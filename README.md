...
> A twitch like web app using RTMP server along with Web server to stream video and other relevant information
...
#### NOTE: Additional Details on JSON Web server and RTMP server are mentioned in the readme inside their respective directory
